classdef JLLErrorsLocal<handle
    ...
    %
    %   Local instance of this .m file is to enable use of JLLErrors in the
    %   Read_Data directory without having the Matlab-Gen-Utils directory
    %   in the path
